...
#Flow Raw
fr_pathnames <- flow_raw20$Pathologist
...
flow_raw20$Pathologist <- paste(fr_lastname, fr_firstname, sep = ', ')

#flow raw 21

fr_pathnames <- flow_raw21$Pathologist
...
flow_raw21$Pathologist <- paste(fr_lastname, fr_firstname, sep = ', ')
...
#flow raw
flow_raw20 <- merge(
            flow_raw20, path_namekey, 
            by= 'Pathologist')
#flow raw 21
flow_raw21 <- merge(
            flow_raw21, path_namekey, 
            by= 'Pathologist')
...
## 2021 Flow Cytology Reports

```{r flow-21, echo=FALSE, message=FALSE}
# Flow Cytology Reports
# Number of reports signed
